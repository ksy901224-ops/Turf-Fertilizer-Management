    ...
    const handleAiSmartFillFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file.name.endsWith('.xlsx') || file.name.endsWith('.xls') || file.name.endsWith('.csv')) {
            ...
            reader.onload = async (event: ProgressEvent<FileReader>) => {
                ...
                // data is string | ArrayBuffer | null
                ...
                // sheet_to_csv returns string or unknown. Ensure it's string.
                const csvResult = XLSX.utils.sheet_to_csv(ws);
                const csvData = String(csvResult);
