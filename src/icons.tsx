...
export const CurrencyWonIcon = ({ className = "h-6 w-6" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const DocumentSearchIcon = ({ className = "h-6 w-6" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const LeafIcon = ({ className = "h-5 w-5" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.633 1.24l-1.954.65a1 1 0 01-1.24-.633l-2.003-6.009-2.003 6.009a1 1 0 01-1.24.633l-1.954-.65a1 1 0 01-.633-1.24 3.989 3.989 0 01-2.667 1.02A3.989 3.989 0 011 14.5a1 1 0 01.285-1.05l1.738-5.42-1.233-.616a1 1 0 01.894-1.79l1.599.8L8 4.323V3a1 1 0 011-1z" clipRule="evenodd" />
    </svg>
);
